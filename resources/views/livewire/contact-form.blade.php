<section id="contato" class="relative bg-white py-24" x-data="{}" x-on:open-url.window="window.open($event.detail.url || (Array.isArray($event.detail) ? $event.detail[0].url || $event.detail[0] : $event.detail), '_blank')">
